...
async function confirm() {
	...
	al = 0;
	if(BASE == "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE") {al = v_d}
	else {al = await(_BASE.allowance(window.ethereum.selectedAddress,SEEDR))}
	if(al<v_d) {
		notice(`
